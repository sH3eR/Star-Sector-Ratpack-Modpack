...
public class MSS_IowaTurretMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        PARTICLE_COLOR.put("default", new Color(163,163,163, 125));
        PARTICLE_COLOR.put("FLASH_ID_3", new Color(163, 163, 163));
        PARTICLE_COLOR.put("FLASH_ID_4", new Color(163, 163, 163));
    }
    ...
    //Instantiator
    public MSS_IowaTurretMuzzleFlashScript() {}
