...
public class MSS_MagicGuidedProjectileScript extends BaseEveryFrameCombatPlugin {
	...
	private static final float GUIDANCE_DELAY_MAX = 20f;
	 ...
	 */
	public MSS_MagicGuidedProjectileScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
