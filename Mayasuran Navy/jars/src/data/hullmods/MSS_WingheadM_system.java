...
public class MSS_WingheadM_system extends BaseHullMod {

    private final Map<String, Integer> SWITCH_SYSTEM_TO = new HashMap<>();

    {
        SWITCH_SYSTEM_TO.put("MSS_Winghead_Elite", 1);
        SWITCH_SYSTEM_TO.put("MSS_Winghead_EliteB", 2);
        SWITCH_SYSTEM_TO.put("MSS_Winghead_EliteC", 3);
        SWITCH_SYSTEM_TO.put("MSS_Winghead_EliteD", 0);
    }

    private final Map<Integer, String> SWITCH_SYSTEM = new HashMap<>();

    {
        SWITCH_SYSTEM.put(0, "MSS_Winghead_Elite");
        SWITCH_SYSTEM.put(1, "MSS_Winghead_EliteB");
        SWITCH_SYSTEM.put(2, "MSS_Winghead_EliteC");
        SWITCH_SYSTEM.put(3, "MSS_Winghead_EliteD");
    }
    ...
    {
        SYSTEMSWITCH.put(0,"MSS_selector_WingheadA");
        SYSTEMSWITCH.put(1,"MSS_selector_WingheadB");
        SYSTEMSWITCH.put(2,"MSS_selector_WingheadC");
        SYSTEMSWITCH.put(3,"MSS_selector_WingheadD");
    }
