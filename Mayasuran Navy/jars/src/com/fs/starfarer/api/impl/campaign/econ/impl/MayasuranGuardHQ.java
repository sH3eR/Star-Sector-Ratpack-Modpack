...
public class MayasuranGuardHQ extends BaseIndustry implements RouteFleetSpawner, FleetEventListener {
	
	@Override
	public boolean isHidden() {
		return !market.getFactionId().equals("mayasura");
	}
	
	@Override
	public boolean isFunctional() {
		return super.isFunctional() && market.getFactionId().equals("mayasura");
	}
...
//		fleet.addScript(ai);
	...
	public String getRouteSourceId() {
		return getMarket().getId() + "_" + "elitemayasuranguard";
	}
