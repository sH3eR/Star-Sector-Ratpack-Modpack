package data.missions.sharkbait;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.setFleetTagline(FleetSide.PLAYER, "Mayasurian Heavy Bombers");
		api.setFleetTagline(FleetSide.ENEMY, "Hegemony Onslaught");
		...
		// Friendly ships
		api.addToFleet(FleetSide.PLAYER, "MSS_Mako_Standard", FleetMemberType.SHIP, true);
		api.addToFleet(FleetSide.PLAYER, "MSS_Mako_Standard", FleetMemberType.SHIP, true);
