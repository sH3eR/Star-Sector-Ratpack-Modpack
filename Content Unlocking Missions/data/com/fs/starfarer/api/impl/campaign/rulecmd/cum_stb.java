...
public class cum_stb extends BaseCommandPlugin {
	...
	public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Token> params, final Map<String, MemoryAPI> memoryMap) {
		...
		config.firstTimeEngageOptionText = "Engage the recon fleet";
		config.afterFirstTimeEngageOptionText = "Re-engage the recon fleet";
