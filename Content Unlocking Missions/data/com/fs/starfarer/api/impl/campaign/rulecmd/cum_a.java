...
public class cum_a extends BaseCommandPlugin {
	...
	public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Token> params, final Map<String, MemoryAPI> memoryMap) {
		...
		config.firstTimeEngageOptionText = "Engage the phase fleet";
		config.afterFirstTimeEngageOptionText = "Re-engage the phase fleet";
