...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		FleetMemberAPI member = api.addToFleet(FleetSide.PLAYER, "conquest_Standard", FleetMemberType.SHIP, "MSS Garuda", true);
        PersonAPI officer = OfficerManagerEvent.createOfficer(Global.getSettings().getModManager().isModEnabled("Mayasuran Navy") ? Global.getSector().getFaction("mayasura") : Global.getSector().getFaction(Factions.PERSEAN), 4, FleetFactoryV3.getSkillPrefForShip(member), true, null, true, false, 0, new Random());
        member.setCaptain(officer);
		FleetMemberAPI member2 = api.addToFleet(FleetSide.PLAYER, "eagle_Assault", FleetMemberType.SHIP, false);
		member2.setCaptain(OfficerManagerEvent.createOfficer(Global.getSettings().getModManager().isModEnabled("Mayasuran Navy") ? Global.getSector().getFaction("mayasura") : Global.getSector().getFaction(Factions.PERSEAN), 1, FleetFactoryV3.getSkillPrefForShip(member2), true, null, true, false, 0, new Random()));
		FleetMemberAPI member3 = api.addToFleet(FleetSide.PLAYER, "falcon_CS", FleetMemberType.SHIP, false);
		member3.setCaptain(OfficerManagerEvent.createOfficer(Global.getSettings().getModManager().isModEnabled("Mayasuran Navy") ? Global.getSector().getFaction("mayasura") : Global.getSector().getFaction(Factions.PERSEAN), 1, FleetFactoryV3.getSkillPrefForShip(member3), true, null, true, false, 0, new Random()));
		FleetMemberAPI member4 = api.addToFleet(FleetSide.PLAYER, "falcon_CS", FleetMemberType.SHIP, false);
		member4.setCaptain(OfficerManagerEvent.createOfficer(Global.getSettings().getModManager().isModEnabled("Mayasuran Navy") ? Global.getSector().getFaction("mayasura") : Global.getSector().getFaction(Factions.PERSEAN), 1, FleetFactoryV3.getSkillPrefForShip(member4), true, null, true, false, 0, new Random()));
		FleetMemberAPI member5 = api.addToFleet(FleetSide.PLAYER, "heron_Strike", FleetMemberType.SHIP, false);
		member5.setCaptain(OfficerManagerEvent.createOfficer(Global.getSettings().getModManager().isModEnabled("Mayasuran Navy") ? Global.getSector().getFaction("mayasura") : Global.getSector().getFaction(Factions.PERSEAN), 1, FleetFactoryV3.getSkillPrefForShip(member5), true, null, true, false, 0, new Random()));
		FleetMemberAPI member6 = api.addToFleet(FleetSide.PLAYER, "heron_Strike", FleetMemberType.SHIP, false);
		member6.setCaptain(OfficerManagerEvent.createOfficer(Global.getSettings().getModManager().isModEnabled("Mayasuran Navy") ? Global.getSector().getFaction("mayasura") : Global.getSector().getFaction(Factions.PERSEAN), 1, FleetFactoryV3.getSkillPrefForShip(member6), true, null, true, false, 0, new Random()));
