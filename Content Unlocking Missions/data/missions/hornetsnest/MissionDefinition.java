...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		FleetMemberAPI member = api.addToFleet(FleetSide.PLAYER, "apogee_Balanced", FleetMemberType.SHIP, "ISS Van Rijn", true);
...
//		api.addToFleet(FleetSide.PLAYER, "hyperion_Strike", FleetMemberType.SHIP, false);
		...
		api.getDefaultCommander(FleetSide.ENEMY).getStats().setSkillLevel(Skills.WOLFPACK_TACTICS, 1);
		...
		api.addToFleet(FleetSide.ENEMY, "buffalo2_FS", FleetMemberType.SHIP, false);
		FleetMemberAPI member1 = api.addToFleet(FleetSide.ENEMY, "hound_Standard", FleetMemberType.SHIP, "Rex", false);
                PersonAPI officer1 = OfficerManagerEvent.createOfficer(Global.getSector().getFaction(Factions.PIRATES), 2, FleetFactoryV3.getSkillPrefForShip(member), true, null, true, true, 2, new Random());
				officer1.setPersonality(Personalities.AGGRESSIVE);
                member1.setCaptain(officer1);
		FleetMemberAPI member2 = api.addToFleet(FleetSide.ENEMY, "hound_Standard", FleetMemberType.SHIP, "Spot", false);
                PersonAPI officer2 = OfficerManagerEvent.createOfficer(Global.getSector().getFaction(Factions.PIRATES), 2, FleetFactoryV3.getSkillPrefForShip(member), true, null, true, true, 2, new Random());
				officer2.setPersonality(Personalities.AGGRESSIVE);
                member2.setCaptain(officer2);
		FleetMemberAPI member3 = api.addToFleet(FleetSide.ENEMY, "hound_Standard", FleetMemberType.SHIP, "Lucky", false);
                PersonAPI officer3 = OfficerManagerEvent.createOfficer(Global.getSector().getFaction(Factions.PIRATES), 2, FleetFactoryV3.getSkillPrefForShip(member), true, null, true, true, 2, new Random());
				officer3.setPersonality(Personalities.AGGRESSIVE);
                member3.setCaptain(officer3);
		FleetMemberAPI member4 = api.addToFleet(FleetSide.ENEMY, "hound_Standard", FleetMemberType.SHIP, "Rusty", false);
                PersonAPI officer4 = OfficerManagerEvent.createOfficer(Global.getSector().getFaction(Factions.PIRATES), 2, FleetFactoryV3.getSkillPrefForShip(member), true, null, true, true, 2, new Random());
				officer4.setPersonality(Personalities.AGGRESSIVE);
                member4.setCaptain(officer4);
