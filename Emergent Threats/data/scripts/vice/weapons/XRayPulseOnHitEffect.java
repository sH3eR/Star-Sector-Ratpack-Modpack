...
public class XRayPulseOnHitEffect implements OnHitEffectPlugin {
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target,
		...
		if (!shieldHit && target instanceof ShipAPI) {
			...
			engine.addHitParticle(point, new Vector2f(), 150, 0.1f, 1f, Color.magenta);
