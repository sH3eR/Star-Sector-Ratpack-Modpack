...
public class AquilonSpatialChargeHandler extends BaseHullMod {
	...
	private static String NEXT_MOD = "vice_aquilon_fl";
	private static String NEXT_MOD_HANDLER = "vice_aquilon_fl_handler";
	private static String THIS_MOD = "vice_aquilon_sc";
	private static String CONFLICT_MOD = "vice_aquilon_mm";
	private static String CONFLICT_MOD_HANDLER = "vice_aquilon_mm_handler";
