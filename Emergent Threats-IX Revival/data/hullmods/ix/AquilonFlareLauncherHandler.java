...
public class AquilonFlareLauncherHandler extends BaseHullMod {
	...
	private static String NEXT_MOD = "ix_aquilon_sr";
	private static String NEXT_MOD_HANDLER = "ix_aquilon_sr_handler";
	private static String THIS_MOD = "ix_aquilon_fl";
	private static String CONFLICT_MOD = "ix_aquilon_sc";
	private static String CONFLICT_MOD_HANDLER = "ix_aquilon_sc_handler";
