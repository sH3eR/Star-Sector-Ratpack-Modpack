...
public class PanopticStrategicRefitButton extends BaseRefitButton {

	private static String CORE_ID = "ix_panopticon_core";

	private static String MOD_ID = "ix_panoptic_strategic";
	...
	public String getButtonName(FleetMemberAPI member, ShipVariantAPI variant) {
		return "Panoptic Interface (Strategic)";
	}
	...
	public void addTooltip(TooltipMakerAPI tooltip, FleetMemberAPI member, ShipVariantAPI variant, MarketAPI market) {
		tooltip.addPara("Panoptic Interface (Strategic)", 0f, Misc.getBasePlayerColor(), Misc.getBasePlayerColor());
		
		tooltip.addSpacer(5f);
		tooltip.addPara("Spend a Story Point to integrate a Panopticon Core strategic module into this ship. Reduces deployment cost by %s, based on hull size.", 0f, Misc.getTextColor(), Misc.getHighlightColor(), "1/2/3/4");
