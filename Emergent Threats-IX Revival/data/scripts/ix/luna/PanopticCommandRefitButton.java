...
public class PanopticCommandRefitButton extends BaseRefitButton {

	private static String CORE_ID = "ix_panopticon_core";

	private static String MOD_ID = "ix_panoptic_command";
	...
	public String getButtonName(FleetMemberAPI member, ShipVariantAPI variant) {
		return "Panoptic Interface (Command)";
	}
	...
	public void addTooltip(TooltipMakerAPI tooltip, FleetMemberAPI member, ShipVariantAPI variant, MarketAPI market) {
		tooltip.addPara("Panoptic Interface (Command)", 0f, Misc.getBasePlayerColor(), Misc.getBasePlayerColor());
