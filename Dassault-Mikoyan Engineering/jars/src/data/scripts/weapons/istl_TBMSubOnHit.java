...
public class istl_TBMSubOnHit implements OnHitEffectPlugin {
    ...
    public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target,
        ...
        if (!shieldHit && target instanceof ShipAPI) {
            ...
            engine.spawnExplosion(point,
                ...
                NEBULA_SIZE * 4, // sets the size of the explosion
                NEBULA_DUR / 5f // how long the explosion lingers for
            );
            //play a sound
