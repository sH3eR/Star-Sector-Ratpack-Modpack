...
public class istl_PlasBolterFX implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {
    
    private static final Color FLASH_COLOR = new Color(155,100,255,235);
    private static final float OFFSET = 4f; // Offset on weapon sprite
    private static final float FLASH_SIZE = 30f; //explosion size
