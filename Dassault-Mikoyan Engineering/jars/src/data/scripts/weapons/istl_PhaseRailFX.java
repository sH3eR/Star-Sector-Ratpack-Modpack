...
public class istl_PhaseRailFX implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {
    
    private static final float OFFSET = 17f; // Offset on weapon sprite; shoud be set to turret offset
    private static final Color FLASH_COLOR = new Color(75,125,200,255); //Color of muzzle flash explosion
    private static final float FLASH_SIZE = 105f; //explosion size
