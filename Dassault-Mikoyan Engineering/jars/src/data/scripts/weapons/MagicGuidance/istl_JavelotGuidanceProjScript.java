...
public class istl_JavelotGuidanceProjScript extends BaseEveryFrameCombatPlugin {
	 ...
	 */
	public istl_JavelotGuidanceProjScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
