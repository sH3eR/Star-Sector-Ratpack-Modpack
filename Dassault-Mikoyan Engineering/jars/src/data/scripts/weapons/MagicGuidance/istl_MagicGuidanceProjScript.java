...
public class istl_MagicGuidanceProjScript extends BaseEveryFrameCombatPlugin {
	...
	private static final float TARGET_REACQUIRE_ANGLE = 120f;

	//How fast the projectile is allowed to turn, in degrees/second
	private static final float TURN_RATE = 300f;
	 ...
	 */
	public istl_MagicGuidanceProjScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
