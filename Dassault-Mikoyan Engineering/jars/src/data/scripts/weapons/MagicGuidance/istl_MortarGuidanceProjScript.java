...
public class istl_MortarGuidanceProjScript extends BaseEveryFrameCombatPlugin {
	...
	private static final float TURN_RATE = 120f;
	 ...
	 */
	public istl_MortarGuidanceProjScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
