...
import static data.scripts.weapons.istl_MinirailOnHit.DAMAGE_MINRADIUS;

import org.lwjgl.util.vector.Vector2f;

import java.awt.Color;

public class istl_PhaseRailOnHit implements OnHitEffectPlugin
{
    public static float DAMAGE = 400f;
    public static float DAMAGE_MAXRADIUS = 180f;
    public static float DAMAGE_MINRADIUS = 90f;
    ...
    private static final float NEBULA_SIZE = 18f * (0.75f + (float) Math.random() * 0.5f);
