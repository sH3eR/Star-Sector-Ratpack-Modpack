...
public class istl_RailSparks12cm implements OnHitEffectPlugin
{
    ...
    private static final float PARTICLE_DURATION = 2.4f;
    private static final int PARTICLE_COUNT = 5;
    // rail slugs hurt
    private static final String SFX = "istl_rail_crit_12cm";
    // -- particle geometry --------------------------------------------------
