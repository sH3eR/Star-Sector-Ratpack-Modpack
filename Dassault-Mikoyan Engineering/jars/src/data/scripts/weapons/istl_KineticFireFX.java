...
public class istl_KineticFireFX implements EveryFrameWeaponEffectPlugin {
    ...
    private static final Color PARTICLE_COLOR = new Color(125,175,255,255); // Particle color
