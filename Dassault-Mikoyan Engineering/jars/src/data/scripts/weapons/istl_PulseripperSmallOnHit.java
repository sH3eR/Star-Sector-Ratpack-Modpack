...
public class istl_PulseripperSmallOnHit extends BaseCombatLayeredRenderingPlugin implements OnHitEffectPlugin {
	...
	public static float TOTAL_DAMAGE = 150;
	...
	public istl_PulseripperSmallOnHit() {
	}
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		...
		istl_PulseripperSmallOnHit effect = new istl_PulseripperSmallOnHit(projectile, (ShipAPI) target, offset);
	...
	public istl_PulseripperSmallOnHit(DamagingProjectileAPI proj, ShipAPI target, Vector2f offset) {
		this.proj = proj;
		this.target = target;
		this.offset = offset;
