...
public class istl_PulseripperLargeOnHit extends BaseCombatLayeredRenderingPlugin implements OnHitEffectPlugin {
	...
	public static float TOTAL_DAMAGE = 250;
	// swirly particle on hit
        ...
        private static final float NEBULA_DUR = 1f;
        private static final float NEBULA_RAMPUP = 0.2f;
	
	public istl_PulseripperLargeOnHit() {
	}
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		...
		istl_PulseripperLargeOnHit effect = new istl_PulseripperLargeOnHit(projectile, (ShipAPI) target, offset);
	...
	public static class ParticleData {
		...
		public ParticleData(float baseSize, float maxDur, float endSizeMult) {
			...
			fader = new FaderUtil(0f, 0.15f, 0.45f);
			fader.forceOut();
			fader.fadeIn();
		}
	...
	protected FaderUtil fader = new FaderUtil(1f, 0.15f, 0.45f); 

	public istl_PulseripperLargeOnHit(DamagingProjectileAPI proj, ShipAPI target, Vector2f offset) {
		this.proj = proj;
		this.target = target;
		this.offset = offset;
