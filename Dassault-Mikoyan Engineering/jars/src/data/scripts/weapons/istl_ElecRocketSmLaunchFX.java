...
public class istl_ElecRocketSmLaunchFX implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {
    
    private static final float OFFSET = 8f; // Offset on weapon sprite; shoud be set to turret offset
    private static final Color FLASH_COLOR = new Color(150,160,255,255); //Color of muzzle flash explosion
    private static final float FLASH_SIZE = 32f; //explosion size
