...
public class Martinique {
	...
	public void generate(SectorAPI sector) {	
		...
		PlanetAPI valjean = system.addPlanet("istl_planet_valjean", martinique_star, "Valjean", "istl_aridbread", 0, 120, 2160, 80);
                ...
                MarketAPI valjeanMarket = AddMarketplace.addMarketplace("independent", valjean, null,
                ...
                // Add United Security spawn script to Valjean. Obsolete, will make an industry.
                ...
                SectorEntityToken martinique_inner_buoy = system.addCustomEntity(null, "Martinique Nav Buoy", "nav_buoy", "dassault_mikoyan"); 
                martinique_inner_buoy.setCircularOrbitPointingDown(martinique_star, 180, 2160, 80);
		...
		system.addRingBand(martinique_star, "misc", "rings_ice0", 256f, 2, Color.white, 256f, 4600, 285f, null, null);
            ...
            MarketAPI novymirMarket = AddMarketplace.addMarketplace("dassault_mikoyan", indStation, null,
                ...
                new ArrayList<>(
                        Arrays.asList( // which submarkets to generate
                                ...
                                Submarkets.SUBMARKET_STORAGE)),
                0.2f); // tariff amount
                novymirMarket.addIndustry(Industries.FUELPROD, new ArrayList<>(Arrays.asList(Items.SYNCHROTRON)));
		...
		Misc.setDefenderOverride(scrap1, new DefenderDataOverride("blade_breakers", 0, 1, 3));
                ...
                Misc.setDefenderOverride(scrap2, new DefenderDataOverride("blade_breakers", 0, 2, 5));
        ...
        // add the marketplace to Antilles Starport --------------- OBSOLETE
