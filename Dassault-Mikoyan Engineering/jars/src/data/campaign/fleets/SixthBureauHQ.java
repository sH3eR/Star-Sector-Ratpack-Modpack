...
public class SixthBureauHQ extends BaseIndustry implements RouteFleetSpawner, FleetEventListener {
	
	@Override
	public boolean isHidden() {
		return !market.getFactionId().equals(istl_Factions.DASSAULT);
	}
	
	@Override
	public boolean isFunctional() {
		return super.isFunctional() && market.getFactionId().equals(istl_Factions.DASSAULT);
	}
...
//		fleet.addScript(ai);
	...
	public String getRouteSourceId() {
		return getMarket().getId() + "_" + "sixthbureau";
	}
