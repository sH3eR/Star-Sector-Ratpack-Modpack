...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.addToFleet(FleetSide.PLAYER, "istl_wanderer_std", FleetMemberType.SHIP, false).getCaptain().setPersonality(Personalities.AGGRESSIVE);
		...
		api.addToFleet(FleetSide.PLAYER, "istl_sevastopol_std", FleetMemberType.SHIP, "SS Just A Working Girl", false).getCaptain().setPersonality(Personalities.CAUTIOUS);
		...
		api.addToFleet(FleetSide.ENEMY, "istl_snakeeye_cqb", FleetMemberType.SHIP, false);
