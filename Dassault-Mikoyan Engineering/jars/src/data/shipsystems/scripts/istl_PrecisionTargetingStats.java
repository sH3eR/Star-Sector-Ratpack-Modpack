...
public class istl_PrecisionTargetingStats extends BaseShipSystemScript {
	public static final Object KEY_JITTER = new Object();
	
	public static final float DAMAGE_INCREASE_PERCENT = 33;
...
//				fStats.getMissileWeaponDamageMult().modifyPercent(id, DAMAGE_INCREASE_PERCENT * effectLevel);
				...
				if (jitterLevel > 0) {
					...
					fighter.setJitterUnder(KEY_JITTER, JITTER_COLOR, jitterLevel, 2, 0f, jitterRangeBonus);
...
//		}
	...
	public StatusData getStatusData(int index, State state, float effectLevel) {
		...
		if (index == 0) {
			...
			return new StatusData("" + Misc.getRoundedValueMaxOneAfterDecimal(DAMAGE_INCREASE_PERCENT * effectLevel) + "% more fighter damage", false);
		}
		return null;
	}
