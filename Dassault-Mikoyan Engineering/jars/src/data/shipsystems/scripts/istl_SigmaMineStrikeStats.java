...
import static com.fs.starfarer.api.impl.combat.MineStrikeStats.getRange;
import com.fs.starfarer.api.impl.combat.MineStrikeStatsAIInfoProvider;
import com.fs.starfarer.api.input.InputEventAPI;
import com.fs.starfarer.api.util.Misc;
import com.fs.starfarer.api.util.WeightedRandomPicker;

public class istl_SigmaMineStrikeStats extends BaseShipSystemScript implements MineStrikeStatsAIInfoProvider {
	
	public static float MINE_RANGE = 1000f;
	
	public static final float MIN_SPAWN_DIST = 30f;
	
	public static final float LIVE_TIME = 2f;
	
	public static final Color JITTER_COLOR = new Color(75,255,175,75);
	public static final Color JITTER_UNDER_COLOR = new Color(75,255,175,155);
