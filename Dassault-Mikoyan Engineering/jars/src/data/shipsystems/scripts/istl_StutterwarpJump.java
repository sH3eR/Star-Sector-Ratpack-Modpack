 ...
 * Uses methods and concepts from Nia Tahl's Errant Drive design with permission.
 */
public class istl_StutterwarpJump extends BaseShipSystemScript {

    private static final Color AFTERIMAGE_COLOR = new Color(55,215,105,85);
    private static final float AFTERIMAGE_THRESHOLD = 0.4f;
    public static final float MAX_TIME_MULT = 4f;

    public static final Color JITTER_COLOR = new Color(75,225,125,90);
    public static final Color JITTER_UNDER_COLOR = new Color(105,255,155,175);
