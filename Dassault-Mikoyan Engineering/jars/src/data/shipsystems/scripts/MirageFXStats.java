...
import static data.scripts.DMEUtils.lerpRGB;
 ...
 */
public abstract class MirageFXStats implements ShipSystemStatsScript
{
    ...
    private static final float PARTICLE_SIZE_MAX = 9f;
            ...
            float effectLevel)
    {
        ...
        // if the MIRAGE system is charging, draw some particles
        // getting sucked in.
        if (state == State.IN)
        {
            // If you like, I could also add some ShaderLib effects
            // here.
            //   - Eliza
            ...
            for (int i = 0; i < n_particles; i++)
            {
                ...
                final Color color
                        = lerpRGB(PARTICLE_COLOR_2, PARTICLE_COLOR_1,
