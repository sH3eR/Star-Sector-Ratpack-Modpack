...
object MCTE_settings {
    ...
    var COMMS_BASE_CP_RATE = 5f

    // SENSOR ARRAY
    var SENSOR_ARRAY_ENABLED = true
    var SENSOR_ARRAY_MAX_DISTANCE = 5000f
    var SENSOR_ARRAY_MIN_DISTANCE = 500f
    var SENSOR_ARRAY_BASE_WEAPON_RANGE_INCREMENT = 150f

    // NAV BUOY
    var NAV_BUOY_ENABLED = true
    var NAV_BUOY_MAX_DISTANCE = 5000f
    var NAV_BUOY_MIN_DISTANCE = 500f
    var NAV_BUOY_BASE_COORD = 10f
