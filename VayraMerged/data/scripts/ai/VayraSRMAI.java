...
public class VayraSRMAI implements MissileAIPlugin, GuidedMissileAI {

    //     SETTINGS     //
    private final float OVERSHOT_ANGLE = 0f;      // Angle with the target beyond which the missile turn around without accelerating. Avoid endless circling. <0 = disabled
    private final float WAVE_TIME = 2f;            // Time to complete a wave in seconds.
    private final float WAVE_AMPLITUDE = 90f;      // Max angle of the waving in degree (divided by 3 with ECCM). Set to a negative value to avoid all waving.
    ...
    private final int fighters = 3;                       //Target class priorities, 0 = ignore
    private final int frigates = 3;                       //Target class priorities, 0 = ignore
    private final int destroyers = 2;                     //Target class priorities, 0 = ignore
    private final int cruisers = 1;                       //Target class priorities, 0 = ignore
    private final int capitals = 1;                       //Target class priorities, 0 = ignore
    ...
    public VayraSRMAI(MissileAPI missile, ShipAPI launchingShip) {
