...
public class KadurBoomerangShieldGuidance extends BaseEveryFrameCombatPlugin {
     ...
     */
    public KadurBoomerangShieldGuidance(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
        this.proj = proj;
        this.target = target;
