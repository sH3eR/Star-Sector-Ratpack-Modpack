...
public class KadurLoyalistSpawner extends BaseIndustry implements RouteFleetSpawner, FleetEventListener {

    public static Logger log = Global.getLogger(KadurLoyalistSpawner.class);

    public static final String FACTION = "kadur_remnant";
    public static final String FLEET_FACTION = "kadur_theocracy";

    // maximum patrols per level
    private static final int BASE_LIGHT = 0;
    ...
    private static final float MEDIUM_FP = 15f;
    private static final float HEAVY_FP = 20f;

    private int level = 1;

    @Override
    public boolean isHidden() {
        return !FACTION.contains(market.getFactionId());
    }

    @Override
    public boolean isFunctional() {
        return super.isFunctional() && FACTION.contains(market.getFactionId());
    }
    ...
    public CampaignFleetAPI spawnFleet(RouteData route) {
        ...
        FleetParamsV3 params = new FleetParamsV3(
                ...
                FLEET_FACTION, // String factionId
                1f, // quality override
                fleetType,
                combat, // combatPts
    ...
    public String getRouteSourceId() {
        return getMarket().getId() + "_" + "kadur_fleetfaction";
    }
