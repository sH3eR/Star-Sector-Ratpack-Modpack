...
public class VayraHyperlostGateInteraction extends BaseCommandPlugin {
    ...
    public static Logger log = Global.getLogger(VayraHyperlostGateInteraction.class);
    ...
    public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Misc.Token> params, final Map<String, MemoryAPI> memoryMap) {
        ...
        if (member == null) {
            ...
            if (!badThingHappened) {
                ...
                VayraGhostShipIntel intel = new VayraGhostShipIntel(GATE_LOST, member, known, null);
