...
void main() {
	vec3 increasedColor = max(texture2D(tex, coord).rgb - hdrScale, 0.0) * 0.255334592;
	increasedColor += max(getFragment(coord.x + scaledPixelDistance) - hdrScale, 0.0) * 0.209853498;
	increasedColor += max(getFragment(coord.x - scaledPixelDistance) - hdrScale, 0.0) * 0.209853498;
	increasedColor += max(getFragment(coord.x + 2.0 * scaledPixelDistance) - hdrScale, 0.0) * 0.117031243;
	increasedColor += max(getFragment(coord.x - 2.0 * scaledPixelDistance) - hdrScale, 0.0) * 0.117031243;
	increasedColor += max(getFragment(coord.x + 3.0 * scaledPixelDistance) - hdrScale, 0.0) * 0.045447963;
	increasedColor += max(getFragment(coord.x - 3.0 * scaledPixelDistance) - hdrScale, 0.0) * 0.045447963;
	increasedColor *= hdr;
