...
public class RATRuinsThemeGenerator extends BaseThemeGenerator {

	public static int MIN_CONSTELLATIONS_WITH_RUINS = 15;
	public static int MAX_CONSTELLATIONS_WITH_RUINS = 25;
