 ...
 * @author Nicke535
 */
public class HyperspatialJavelinHomingEffect extends BaseEveryFrameCombatPlugin {
    ...
    private static final float GUIDANCE_DELAY_MAX = 0.05f;
     ...
     */
    public HyperspatialJavelinHomingEffect(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
        this.proj = proj;
        this.target = target;
