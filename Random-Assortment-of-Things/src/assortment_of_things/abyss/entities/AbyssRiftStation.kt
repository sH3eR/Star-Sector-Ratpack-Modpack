...
class AbyssRiftStation : BaseCustomEntityPlugin() {
    ...
    override fun render(layer: CampaignEngineLayers?, viewport: ViewportAPI?) {
        ...
        if (layer == CampaignEngineLayers.TERRAIN_7) {
            wormhole.setSize(9500f, 9500f)
            wormhole.setAdditiveBlend()
            wormhole.alphaMult = 0.1f
            ...
            wormhole2.setSize(10000f, 10000f)
            wormhole2.setAdditiveBlend()
            wormhole2.alphaMult = 0.1f
            ...
            wormhole3.setSize(15000f, 15000f)
            wormhole3.setAdditiveBlend()
            wormhole3.alphaMult = 0.1f
