 ...
 * @author Nicke535
 */
public class AzazelsBladeHomingEffect extends BaseEveryFrameCombatPlugin {
    ...
    private static final float TURN_RATE = 100f;
    ...
    private static final float GUIDANCE_DELAY_MAX = 0.10f;
    private static final float GUIDANCE_DELAY_MIN = 0.10f;
     ...
     */
    public AzazelsBladeHomingEffect(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
        this.proj = proj;
        this.target = target;
