package assortment_of_things.abyss.terrain.terrain_copy;
...
public class OldHyperspaceTerrainPlugin extends OldBaseTiledTerrain { // implements NebulaTextureProvider {
...
//			}
	...
	Object writeReplace() {
		OldHyperspaceTerrainPlugin copy = (OldHyperspaceTerrainPlugin) super.writeReplace();
