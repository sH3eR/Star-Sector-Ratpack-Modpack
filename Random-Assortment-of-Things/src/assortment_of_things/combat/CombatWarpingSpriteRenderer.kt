...
class CombatWarpingSpriteRenderer(var chunks: Int, var speedMod: Float) : WarpingSpriteRenderer(chunks, chunks) {
    ...
    fun render(sprite: Sprite, disableBlend: Boolean, viewport: ViewportAPI) {
        ...
        GL11.glTranslatef(viewport.llx, viewport.lly, 0.0f)
        GL11.glEnable(3553)
        if (disableBlend) {
            GL11.glDisable(3042)
        }
