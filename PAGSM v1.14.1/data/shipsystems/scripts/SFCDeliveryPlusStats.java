...
public class SFCDeliveryPlusStats extends BaseShipSystemScript implements MineStrikeStatsAIInfoProvider {
	
	protected static float MINE_RANGE = 2000f;
	
	public static final float MIN_SPAWN_DIST = 50f;
	public static final float MIN_SPAWN_DIST_FRIGATE = 75f;
	
	public static final float LIVE_TIME = 10f;
	
	public static final Color JITTER_COLOR = new Color(255, 255,255, 155);
	public static final Color JITTER_UNDER_COLOR = new Color(155, 155, 155, 155);
...
//			mine.getDamage().setMultiplier(mine.getDamage().getMultiplier() * extraDamageMult);
		...
		Global.getSoundPlayer().playSound("system_teleport", 1f, 1f, mine.getLocation(), mine.getVelocity());
	}
