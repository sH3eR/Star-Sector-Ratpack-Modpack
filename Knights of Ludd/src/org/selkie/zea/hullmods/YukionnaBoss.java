...
import org.selkie.zea.combat.subsystems.BallLightningSubsystem;
import org.selkie.zea.combat.subsystems.BlizzardSubsystem;
    ...
    public static class YukionnaBossPhaseTwoScript implements AdvanceableListener, HullDamageAboutToBeTakenListener {
        ...
        public void advance(float amount) {
            ...
            if (phaseTwo && phaseTwoTimer < MAX_TIME) {
                ...
                SpriteAPI glow1 = Global.getSettings().getSprite(GfxCat.PHASE_GLOWS, ship.getHullSpec().getBaseHullId() + "_glow1");
                SpriteAPI glow2 = Global.getSettings().getSprite(GfxCat.PHASE_GLOWS, ship.getHullSpec().getBaseHullId() + "_glow2");
