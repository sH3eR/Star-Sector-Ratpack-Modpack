...
public class ZeaMechanicIntel extends BaseIntelPlugin {
    ...
    private static final ArrayList<String[]> dawnHLs = new ArrayList<>();
    static {
    ...
    private static final ArrayList<String[]> duskHLs = new ArrayList<>();
    static {
        String[] hl1 = {"skirmishes", "heavy strikes", "ubiquitous motes", "NOT"};
        duskHLs.add(hl1);
    }
    private static final String[] edf = {
    ...
    private static final ArrayList<String[]> edfHLs = new ArrayList<>();
    static {
...
private static final ArrayList<String[]> TTHLs = new ArrayList<>();
    private static final String[] KoL = {
...
private static final ArrayList<String[]> KoLHLs = new ArrayList<>();
    static {
    ...
    public static ZeaMechanicIntel getNextMechanicIntel(String id) {
        ...
        String title = Global.getSector().getFaction(id).getDisplayName() + " Assessment #" + (entry + 1);
