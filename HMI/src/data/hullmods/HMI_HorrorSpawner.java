...
public class HMI_HorrorSpawner extends BaseHullMod {
	...
	static {
		...
		large.get(ShardType.GENERAL).add("hmi_spookyboi_phase2_std");

		large.get(ShardType.ANTI_ARMOR).add("hmi_spookyboi_phase2_std");

		large.get(ShardType.ANTI_SHIELD).add("hmi_spookyboi_phase2_std");

		large.get(ShardType.POINT_DEFENSE).add("hmi_spookyboi_phase2_std");

		large.get(ShardType.MISSILE).add("hmi_spookyboi_phase2_std");
	}
