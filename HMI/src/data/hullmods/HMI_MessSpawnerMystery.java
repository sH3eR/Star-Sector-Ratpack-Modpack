...
public class HMI_MessSpawnerMystery extends BaseHullMod {
...
//		fighters.get(ShardType.GENERAL).add("drone_feeder_stripper", 10f);
//		fighters.get(ShardType.GENERAL).add("drone_feeder_heavy_Fighter", 1f);

//		fighters.get(ShardType.MISSILE).add("drone_feeder_stripper", 10f);

//		fighters.get(ShardType.ANTI_ARMOR).add("drone_feeder_stripper", 10f);

//		fighters.get(ShardType.ANTI_SHIELD).add("drone_feeder_stripper", 10f);

//		fighters.get(ShardType.POINT_DEFENSE).add("drone_feeder_stripper", 10f);
	...
	public void advanceInCombat(ShipAPI ship, float amount) {
		...
		engine.setCombatNotOverForAtLeast(SPAWN_TIME + 1f);
			...
			if (engine.getFleetManager(ship.getOwner()) == engine.getFleetManager(FleetSide.PLAYER)) return;
