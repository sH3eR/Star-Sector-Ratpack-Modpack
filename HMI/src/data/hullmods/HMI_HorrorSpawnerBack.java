...
public class HMI_HorrorSpawnerBack extends BaseHullMod {
	...
	static {
		...
		small.get(ShardType.GENERAL).add("hmi_spookyboi_back_2_std", 10f);

		small.get(ShardType.ANTI_ARMOR).add("hmi_spookyboi_back_2_std", 10f);

		small.get(ShardType.ANTI_SHIELD).add("hmi_spookyboi_back_2_std", 10f);


		small.get(ShardType.POINT_DEFENSE).add("hmi_spookyboi_back_2_std", 10f);

		small.get(ShardType.MISSILE).add("hmi_spookyboi_back_2_std", 10f);
		...
		medium.get(ShardType.GENERAL).add("hmi_spookyboi_back_2_std");

		medium.get(ShardType.ANTI_ARMOR).add("hmi_spookyboi_back_2_std");

		medium.get(ShardType.ANTI_SHIELD).add("hmi_spookyboi_back_2_std");

		medium.get(ShardType.POINT_DEFENSE).add("hmi_spookyboi_back_2_std");

		medium.get(ShardType.MISSILE).add("hmi_spookyboi_back_2_std");

		ShardTypeVariants large = new ShardTypeVariants();
		variantData.put(HullSize.CAPITAL_SHIP, large);

		large.get(ShardType.GENERAL).add("hmi_spookyboi_back_2_std");

		large.get(ShardType.ANTI_ARMOR).add("hmi_spookyboi_back_2_std");

		large.get(ShardType.ANTI_SHIELD).add("hmi_spookyboi_back_2_std");

		large.get(ShardType.POINT_DEFENSE).add("hmi_spookyboi_back_2_std");

		large.get(ShardType.MISSILE).add("hmi_spookyboi_back_2_std");
	}
