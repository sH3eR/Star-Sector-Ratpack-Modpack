...
public class HMI_HorrorSpawner4 extends BaseHullMod {
	...
	static {
		...
		small.get(ShardType.GENERAL).add("hmi_spookyboi_phase5_variant", 10f);

		small.get(ShardType.ANTI_ARMOR).add("hmi_spookyboi_phase5_variant", 10f);

		small.get(ShardType.ANTI_SHIELD).add("hmi_spookyboi_phase5_variant", 10f);


		small.get(ShardType.POINT_DEFENSE).add("hmi_spookyboi_phase5_variant", 10f);

		small.get(ShardType.MISSILE).add("hmi_spookyboi_phase5_variant", 10f);
		...
		medium.get(ShardType.GENERAL).add("hmi_spookyboi_phase5_variant");

		medium.get(ShardType.ANTI_ARMOR).add("hmi_spookyboi_phase5_variant");

		medium.get(ShardType.ANTI_SHIELD).add("hmi_spookyboi_phase5_variant");

		medium.get(ShardType.POINT_DEFENSE).add("hmi_spookyboi_phase5_variant");

		medium.get(ShardType.MISSILE).add("hmi_spookyboi_phase5_variant");

		ShardTypeVariants large = new ShardTypeVariants();
		variantData.put(HullSize.CAPITAL_SHIP, large);

		large.get(ShardType.GENERAL).add("hmi_spookyboi_phase5_variant");

		large.get(ShardType.ANTI_ARMOR).add("hmi_spookyboi_phase5_variant");

		large.get(ShardType.ANTI_SHIELD).add("hmi_spookyboi_phase5_variant");

		large.get(ShardType.POINT_DEFENSE).add("hmi_spookyboi_phase5_variant");

		large.get(ShardType.MISSILE).add("hmi_spookyboi_phase5_variant");
	}
