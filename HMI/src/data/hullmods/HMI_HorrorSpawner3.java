...
public class HMI_HorrorSpawner3 extends BaseHullMod {

	public static Color JITTER_COLOR = new Color(255,100, 100,50);
	...
	static {
		...
		small.get(ShardType.GENERAL).add("hmi_spookyboi_phase4_left_std", 10f);

		small.get(ShardType.ANTI_ARMOR).add("hmi_spookyboi_phase4_left_std", 10f);

		small.get(ShardType.ANTI_SHIELD).add("hmi_spookyboi_phase4_left_std", 10f);


		small.get(ShardType.POINT_DEFENSE).add("hmi_spookyboi_phase4_left_std", 10f);

		small.get(ShardType.MISSILE).add("hmi_spookyboi_phase4_left_std", 10f);
		...
		medium.get(ShardType.GENERAL).add("hmi_spookyboi_phase4_right_std", 10f);

		medium.get(ShardType.ANTI_ARMOR).add("hmi_spookyboi_phase4_right_std", 10f);

		medium.get(ShardType.ANTI_SHIELD).add("hmi_spookyboi_phase4_right_std", 10f);

		medium.get(ShardType.POINT_DEFENSE).add("hmi_spookyboi_phase4_right_std", 10f);

		medium.get(ShardType.MISSILE).add("hmi_spookyboi_phase4_right_std", 10f);

		ShardTypeVariants large = new ShardTypeVariants();
		variantData.put(HullSize.CAPITAL_SHIP, large);

		large.get(ShardType.GENERAL).add("hmi_spookyboi_phase4_std", 10f);

		large.get(ShardType.ANTI_ARMOR).add("hmi_spookyboi_phase4_std", 10f);

		large.get(ShardType.ANTI_SHIELD).add("hmi_spookyboi_phase4_std", 10f);

		large.get(ShardType.POINT_DEFENSE).add("hmi_spookyboi_phase4_std", 10f);

		large.get(ShardType.MISSILE).add("hmi_spookyboi_phase4_std", 10f);
	}
...
//		Global.getCombatEngine().addPlugin(createShipFadeInPlugin("shard_right_Attack", ship, 0f, dur));
	...
	public WeightedRandomPicker<ShardType> getTypePickerBasedOnLocalConditions(ShipAPI ship) {
		...
		float total = weightGoodShields + weightGoodArmor + weightVulnerable + weightCarriers;
		if (total <= 1f) total = 1f;

		float antiFighter = (weightCarriers) / total;
