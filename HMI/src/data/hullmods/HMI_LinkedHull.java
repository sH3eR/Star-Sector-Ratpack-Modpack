...
public class HMI_LinkedHull extends BaseHullMod {
...
//        }
    ...
    private static void advanceParent(ShipAPI parent, List<ShipAPI> children) {
        ...
        if (ec != null) {
            ...
            parent.getMutableStats().getAcceleration().modifyMult("hmi_linkedhull", enginePerformance);
            parent.getMutableStats().getDeceleration().modifyMult("hmi_linkedhull", enginePerformance);
            parent.getMutableStats().getTurnAcceleration().modifyMult("hmi_linkedhull", enginePerformance);
            parent.getMutableStats().getMaxTurnRate().modifyMult("hmi_linkedhull", enginePerformance);
            parent.getMutableStats().getMaxSpeed().modifyMult("hmi_linkedhull", enginePerformance);
            parent.getMutableStats().getZeroFluxSpeedBoost().modifyMult("hmi_linkedhull", enginePerformance);
        }
    }
    ...
    public void applyEffectsAfterShipCreation(ShipAPI ship, String id) {
        ...
        switch (ship.getHullSpec().getBaseHullId()) {
            case "hmi_locomotive_rear":
            case "hmi_locomotive_gun_left":
            case "hmi_locomotive_gun_right":
            case "hmi_locomotive_fighter_left":
            case "hmi_locomotive_fighter_right":
            case "hmi_locomotive_front":
