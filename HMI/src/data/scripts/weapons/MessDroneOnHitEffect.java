...
public class MessDroneOnHitEffect extends BaseCombatLayeredRenderingPlugin implements OnHitEffectPlugin {
	...
	public static float TOTAL_DAMAGE = 200;
	
	public MessDroneOnHitEffect() {
	}
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		...
		MessDroneOnHitEffect effect = new MessDroneOnHitEffect(projectile, (ShipAPI) target, offset);
	...
	public MessDroneOnHitEffect(DamagingProjectileAPI proj, ShipAPI target, Vector2f offset) {
		this.proj = proj;
		this.target = target;
		this.offset = offset;
	...
	public void render(CombatEngineLayers layer, ViewportAPI viewport) {
		...
		Color red = new Color(224, 225, 255,100);
