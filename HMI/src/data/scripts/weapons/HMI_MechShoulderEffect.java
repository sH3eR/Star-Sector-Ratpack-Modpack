 ...
 * @author Tartiflette
 */
public class HMI_MechShoulderEffect implements EveryFrameWeaponEffectPlugin{    
    ...
    public void advance(float amount, CombatEngineAPI engine, WeaponAPI weapon) {
        ...
        weapon.setCurrAngle(ship.getFacing() + MathUtils.getShortestRotation(ship.getFacing(),reference.getCurrAngle())*0.4f);
    }
}
