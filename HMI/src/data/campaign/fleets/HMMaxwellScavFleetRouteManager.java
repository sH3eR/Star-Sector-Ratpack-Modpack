...
public class HMMaxwellScavFleetRouteManager extends BaseRouteFleetManager {

	protected StarSystemAPI system;

	public HMMaxwellScavFleetRouteManager(StarSystemAPI system) {
		super(1f, 14f);
		this.system = system;
	}
	...
	protected int getMaxFleets() {
		...
		return (int) (1 + Math.min(salvage*numRemnantSystems * 3 , 8));
	}
...
//This will do for the time being
		...
		for (MarketAPI market : Global.getSector().getEconomy().getMarketsCopy()) {
			if (!market.getFactionId().equals("hmi_maxwell")) continue;
	...
	public CampaignFleetAPI spawnFleet(RouteData route) {
		...
		fleet.addTag("hmi_MaxwellScavFleet");
