...
public class HMI_MaxwellMedMarketPlugin extends BaseSubmarketPlugin {


    private boolean playerPaidToUnlock = false;
    private float sinceLastUnlock = 0f;
    private static final float  getUnlockCost = 0.35f;
    ...
    public String getDialogText(CoreUIAPI ui) {
        ...
        if (canPlayerAffordUnlock()) {
            ...
            return "\"Access to the Maxwell Defense Market costs "
...
//       if (relationship <= getUnlockCost && !playerPaidToUnlock) {
    ...
    public void updateCargoPrePlayerInteraction() {
        ...
        if (okToUpdateShipsAndWeapons()) {
            ...
            addWeapons(weapons, weapons + 8, 2, "hmi_maxwell");
            addFighters(fighters, fighters + 4, 2, "hmi_maxwell");


            getCargo().getMothballedShips().clear();

            FleetMemberAPI memberoddy = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "odyssey_hmimax_Hull");
            ...
            FleetMemberAPI memberapogee2 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "apogee_hmimax_Hull");
            memberapogee2.getRepairTracker().setMothballed(true);
            memberapogee2.getRepairTracker().setCR(0.5f);
            getCargo().getMothballedShips().addFleetMember(memberapogee2);


            FleetMemberAPI memberfury = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "fury_hmimax_Hull");
            ...
            FleetMemberAPI memberfury2 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "fury_hmimax_Hull");
            ...
            FleetMemberAPI memberfury3 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "fury_hmimax_Hull");
            memberfury3.getRepairTracker().setMothballed(true);
            memberfury3.getRepairTracker().setCR(0.5f);
            getCargo().getMothballedShips().addFleetMember(memberfury3);
            ...
            FleetMemberAPI memberhippo2 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "hippocampus_hmimax_Hull");
            ...
            FleetMemberAPI memberhippo3 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "hippocampus_hmimax_Hull");
            memberhippo3.getRepairTracker().setMothballed(true);
            memberhippo3.getRepairTracker().setCR(0.5f);
            getCargo().getMothballedShips().addFleetMember(memberhippo3);


            FleetMemberAPI membermule = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "shrike_hmimax_Hull");
            ...
            FleetMemberAPI membermule2 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "shrike_hmimax_Hull");
            ...
            FleetMemberAPI membermule3 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "shrike_hmimax_Hull");
            ...
            FleetMemberAPI membermule4 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "shrike_hmimax_Hull");
            membermule4.getRepairTracker().setMothballed(true);
            membermule4.getRepairTracker().setCR(0.5f);
            getCargo().getMothballedShips().addFleetMember(membermule4);




            FleetMemberAPI membercerberus = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "omen_hmimax_Hull");
            ...
            FleetMemberAPI membercerberus2 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "omen_hmimax_Hull");
            ...
            FleetMemberAPI memberwayfarer = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "vigilance_hmimax_Hull");
            ...
            FleetMemberAPI memberwayfarer2 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "vigilance_hmimax_Hull");
            ...
            FleetMemberAPI memberwayfarer3 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "vigilance_hmimax_Hull");
            ...
            FleetMemberAPI member_remora = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "wolf_hmimax_Hull");
            ...
            FleetMemberAPI member_remora2 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "wolf_hmimax_Hull");
            ...
            FleetMemberAPI member_remora3 = Global.getFactory().createFleetMember(FleetMemberType.SHIP, "wolf_hmimax_Hull");
            ...
            addHullMods(2, 1 + itemGenRandom.nextInt(3));
        }
