...
public class BlackLuddAssignmentAI implements EveryFrameScript {
	...
	public BlackLuddAssignmentAI(CampaignFleetAPI fleet, StarSystemAPI homeSystem, SectorEntityToken source) {
		this.fleet = fleet;
