...
public class HMIRAMPANTAssignmentAI implements EveryFrameScript {
	...
	public HMIRAMPANTAssignmentAI(CampaignFleetAPI fleet, StarSystemAPI homeSystem, SectorEntityToken source) {
		this.fleet = fleet;
	...
	protected void pickNext() {
		...
		if (!standDown) {
			SectorEntityToken target = BlackLuddSeededFleetManager.pickEntityToGuard(new Random(), homeSystem, fleet);
			if (target != null) {
