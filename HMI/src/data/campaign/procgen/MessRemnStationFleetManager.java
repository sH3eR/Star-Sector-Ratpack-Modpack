...
public class MessRemnStationFleetManager extends SourceBasedFleetManager {

	protected int minPts;
	protected int maxPts;
	protected int totalLost;

	public MessRemnStationFleetManager(SectorEntityToken source, float thresholdLY, int minFleets, int maxFleets, float respawnDelay,
	...
	protected CampaignFleetAPI spawnFleet() {
		...
		if (combatPoints > 50) type = FleetTypes.PATROL_LARGE;
