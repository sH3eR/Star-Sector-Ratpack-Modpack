...
public class MessRemnAssignmentAI implements EveryFrameScript {
	...
	public MessRemnAssignmentAI(CampaignFleetAPI fleet, StarSystemAPI homeSystem, SectorEntityToken source) {
		this.fleet = fleet;
	...
	protected void pickNext() {
		...
		if (!standDown) {
			SectorEntityToken target = MessRemnSeededFleetManager.pickEntityToGuard(new Random(), homeSystem, fleet);
			if (target != null) {
