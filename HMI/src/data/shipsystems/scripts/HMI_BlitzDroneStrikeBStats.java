...
public class HMI_BlitzDroneStrikeBStats extends BaseShipSystemScript implements DroneStrikeStatsAIInfoProvider {
	...
	public static class DroneMissileScript extends BaseCombatLayeredRenderingPlugin {
		...
		public void advance(float amount) {
			...
			drone.setJitter(this, new Color(255,180, 100, (int)(25 + 50 * jitterFraction)), 1f, 10, 1f, jitterMax);
...
//			}
	...
	public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
		...
		for (ShipAPI drone : getDrones(ship)) {
			...
			drone.setExplosionFlashColorOverride(new Color(255, 180, 100, 255));
		}
...
//				drone.setHitpoints(-1f);
				...
				//float thickness = 16f;
				float thickness = 10f;
				float coreWidthMult = 0.33f;
				EmpArcEntityAPI arc = engine.spawnEmpArcVisual(ship.getLocation(), ship,
						missile.getLocation(), missile, thickness, new Color(255, 221, 100,255), Color.white);
