...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.addBriefingItem("The patrol is equipped with Avaritia, boosting vent speed and providing a damage boost after venting.");
		api.addBriefingItem("Use Ctrl and the number keys to create a group of Wolves to strike."); //Copied from tips.json
		api.addBriefingItem("Defeat all enemy forces. HSS Korei Miko must survive.");
		
			// Set up the player's fleet
			FleetMemberAPI member = api.addToFleet(FleetSide.PLAYER, "eis_audacious_special", FleetMemberType.SHIP, "HSS Korei Miko", true);
			...
			FleetMemberAPI member1 = api.addToFleet(FleetSide.PLAYER, "eis_wolf_avaritia", FleetMemberType.SHIP, "HSS Seiryuu", true);
			FleetMemberAPI member2 = api.addToFleet(FleetSide.PLAYER, "eis_wolf_avaritia", FleetMemberType.SHIP, "HSS Suzaku", false);
			FleetMemberAPI member3 = api.addToFleet(FleetSide.PLAYER, "eis_wolf_avaritia", FleetMemberType.SHIP, "HSS Byakko", false);
			FleetMemberAPI member4 = api.addToFleet(FleetSide.PLAYER, "eis_wolf_avaritia", FleetMemberType.SHIP, "HSS Genbu", false);
			FleetMemberAPI member5 = api.addToFleet(FleetSide.PLAYER, "eis_condor_wow", FleetMemberType.SHIP, false);
			// Mark player flagship as essential
			api.defeatOnShipLoss("HSS Korei Miko");
