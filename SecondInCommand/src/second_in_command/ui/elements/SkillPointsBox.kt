...
class SkillPointsBox(tooltip: TooltipMakerAPI, width: Float, height: Float) : LunaElement(tooltip, width, height) {

    var points = Global.getSector().playerPerson.stats.points
    var textPara: LabelAPI
    var textColor = Misc.getBasePlayerColor()

    var numberPara: LabelAPI
    var numberColor = Misc.getHighlightColor()
    ...
    init {
        ...
        textPara = inner.addPara("Skill Points", 0f, textColor, textColor)
