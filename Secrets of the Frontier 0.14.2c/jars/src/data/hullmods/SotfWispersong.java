...
public class SotfWispersong extends SotfBaseConcordAugment
{
    ...
    public void addPostDescriptionSection(TooltipMakerAPI tooltip, ShipAPI.HullSize hullSize, ShipAPI ship, float width, boolean isForModSpec) {
        ...
        LabelAPI label = tooltip.addPara("\"Sing to the wisps, and they shall answer. They're always listening - " +
                "you just need to convince them it's time to play!... okay, no, I see what you're getting at with the crazy-talk now.\"", SotfMisc.getSierraColor().darker(), opad);
        label.italicize();
