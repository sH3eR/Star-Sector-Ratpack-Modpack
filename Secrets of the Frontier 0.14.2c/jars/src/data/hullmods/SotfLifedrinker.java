...
public class SotfLifedrinker extends SotfBaseConcordAugment {
    ...
    public static class SotfLifedrinkerArmorRepairScript implements AdvanceableListener {
        ...
        public void advance(float amount) {
            ...
            SotfMisc.repairMostDamaged(ship, REPAIR_PER_SECOND * amount * timeMult);
    ...
    public void applyEffectsBeforeShipCreation(ShipAPI.HullSize hullSize, MutableShipStatsAPI stats, String id) {
        stats.getBeamDamageTakenMult().modifyMult(id, REFLECTION_MULT);
        stats.getEmpDamageTakenMult().modifyMult(id, REFLECTION_MULT);
