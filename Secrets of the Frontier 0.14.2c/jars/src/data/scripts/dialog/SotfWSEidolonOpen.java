    ...
    public void advance(float amount) {
        ...
        if (counter >= 5 && stage == 1) {
            ...
            if (counter >= 2 && stage == 8) {
                ...
                if (sufferingMode) {
                    wispmother1.getVariant().addMod("sotf_wispblossom");
                    wispmother2.getVariant().addMod("sotf_wispblossom");
                ...
                for (FleetMemberAPI member : enemyFleetTemp.getFleetData().getMembersListCopy()) {
                    ...
                    if (!member.getVariant().getHullMods().contains("sotf_phantasmalship")) {
                        member.getVariant().addPermaMod("sotf_phantasmalship");
                    }
                    if (member == vow) {
                        continue;
                    }
