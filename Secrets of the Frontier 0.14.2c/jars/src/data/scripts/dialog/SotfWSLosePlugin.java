...
public class SotfWSLosePlugin implements InteractionDialogPlugin {
        ...
        switch (option) {
            ...
            case DRAGGED:
                ...
                if (SotfMisc.playerHasSierra() && !Global.getSector().getMemoryWithoutUpdate().contains("$sotf_WSSecondTime")) {
                    ...
                    break;
                } else if (!SotfMisc.playerHasSierra() && !Global.getSector().getMemoryWithoutUpdate().contains("$sotf_WSSecondTime")) {
