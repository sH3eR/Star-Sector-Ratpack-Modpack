...
public class SotfPeople {
    ...
    public static void createCharacters() {
        ...
        courser.setRankId(Ranks.SPACE_COMMANDER);
        SotfMisc.giveDustkeeperName(courser, "Outrider", "Annex", "Courser");

        PersonAPI wendigo = getPerson(WENDIGO);
        wendigo.setPostId(SotfIDs.POST_HUNTERKILLER);
    }
    ...
    public static PersonAPI genWarhorn(boolean ghost) {
        ...
        person.getMemoryWithoutUpdate().set("$chatterChar", "sotf_warhorn");
        return person;
    }
}
