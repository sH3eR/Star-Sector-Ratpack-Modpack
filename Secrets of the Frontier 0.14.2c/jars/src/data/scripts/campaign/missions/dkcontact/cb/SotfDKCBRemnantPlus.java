...
/**
 *	Dustkeeper version of Omega bounty
 */


public class SotfDKCBRemnantPlus extends SotfBaseDKCBCreator {
	...
	public float getFrequency(HubMissionWithBarEvent mission, int difficulty) {
		if (mission.getPerson().getId().equals(SotfPeople.INADVERTENT)) return 0;
	...
	public String getNumCompletedGlobalKey() {
		return "$CBRemnantPlus_numCompleted";
	}
