...
public class SotfDKCBRemnant extends SotfBaseDKCBCreator {
...
//		}
		...
		// always an Alpha core commander
		PersonAPI commander = Misc.getAICoreOfficerPlugin(Commodities.ALPHA_CORE).createPerson(Commodities.ALPHA_CORE, Factions.REMNANTS, mission.getGenRandom());
		...
		data.fleet.getFlagship().setCaptain(commander);
		RemnantOfficerGeneratorPlugin.integrateAndAdaptCoreForAIFleet(data.fleet.getFlagship());
		data.fleet.setCommander(commander);
