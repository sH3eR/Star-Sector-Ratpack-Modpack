...
/**
 * Yeah this is just a purple version of vanilla's cut NeuralTransferVisual lol
 * Displays wavy beam visual thingy from one ship towards another ship briefly
 * Yeah I can kind of see why they cut the thing but it kinda looks cool when the two beams zoop together!
 */

public class SotfSoulbondBondVisual extends BaseCombatLayeredRenderingPlugin {
	...
	public SotfSoulbondBondVisual(ShipAPI from, ShipAPI to, float duration) {
		this.from = from;
		this.to = to;
		this.duration = duration;
		
		sprite = Global.getSettings().getSprite("fx", "sotf_soulbond_beam");
		fader.fadeIn();
	}
	...
	public void render(CombatEngineLayers layer, ViewportAPI viewport) {
		...
		Color color = new Color(155,70,246,255);
